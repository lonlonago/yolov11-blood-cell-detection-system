# YOLOv11 Blood Cell Detection System

## Body

YOLOv11 Blood Cell Detection System Based on Deep Learning YOLOv11 for Red Blood Cells, White Blood Cells, and Platelets Detection (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 3 classes,
Name: ['Platelets', 'RBC', 'WBC'],
Dataset quantity: training set 765 images, validation set 73 images, test set 36 images.
